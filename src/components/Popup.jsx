  ...
  renderPrivacyInfo = () => (
    <Fragment>
      <div className='privacyInfo'>
        <button onClick={() => console.log('123')}>Назад</button>
  ...
  renderProcess = () => {
    ...
    return (
      <Fragment>
        ...
        <p className='size__font-12px'>Нажимая кнопку “Связаться с нами“, Вы даете<br /><a onClick={this.handlePrivacyClick}>согласие на обработку персональных данных.</a></p>
      </Fragment>
    )
  }
  render () {
